...
2. **Проверка чисел:**
 ...
 3. **Сравнение чисел:**  
    a). Программа сравнивает значения `x` и `a`. Если `x` меньше или равно `a`, программа переходит к следующему шагу для работы с `x`. Если `x` больше, программа выполняет действия вывода ответа на экран.
   b). Программа сравнивает значения `x` и `b`. Если `x` меньше или равно `b`, программа переходит к следующему шагу для работы с `x`. Если `x` больше, программа выполняет действия вывода ответа на экран.
   c). Программа сравнивает значения `x` и `c`. Если `x` меньше или равно `c`, программа переходит к следующему шагу для работы с `x`. Если `x` больше, программа выполняет действия вывода ответа на экран.
   d). Программа сравнивает значения `x` и `d`. Если `x` меньше или равно `d`, программа переходит к выводу окончательного ответа на экран, выводя максимальное значение. Если `x` больше, программа выполняет действия вывода ответа на экран.
