...
- Необходимо последовательно сравнить диаметр шара X с диаметрами отверстий. Сначала с A, затем с B, после с C и в конце концов с D. Если диаметр шара слишком большой для отверстия диаметром A и не может через
- него пройти, то шар не сможет пройти и через остальные остальные отверстия диаметрами B, C и D. Такие же ситуации стоит рассмотреть
