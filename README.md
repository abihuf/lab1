...
2. **Сравнение чисел:**  
   ...
   работы с `x`. Если `x` больше, программа выполняет действия вывода ответа на экран.
   4. Программа сравнивает значения `x` и `d`. Если `x` меньше или равно `d`, программа переходит выводу отввета на экран.
   Если `x` больше, программа выполняет действия вывода ответа на экран.
...
public class Main {
    ...
    public static void main(String[] args){
        ...
        while (a <= 0 || b <= 0 || c <= 0 || d <= 0) {
            out.println("В последовательности присутствует ненатуральное число. Введите последовательность, содержащую только положительные числа");
            a = in.nextInt();
            b = in.nextInt();
            c = in.nextInt();
            d = in.nextInt();
