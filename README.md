...
На вход программа должна получать 5 чисел, принадлежащих множеству натуральных чисел N. Так как верхняя и нижняя границы вводимых чисел в условии не даны, мы установим их сами.Так, нижняя граница будет равна 1, так как 0 и числа меньше него - не натуральные; а верхняя граница будет равна 10<sup>9/<sup>, так как вместительность типа данных int составляет 2<sup>32 степени.
чисел.
